const CoffeeData = [
  ...
  },
  {
    ...
    roasted: 'Medium Roasted',
    imagelink_square: require('../assets/coffee_assets/cortado/square/cortado_pic_1_square.png'),
    imagelink_portrait: require('../assets/coffee_assets/cortado/portrait/cortado_pic_1_portrait.png'),
    ingredients: 'Milk',
    special_ingredient: 'With Steamed Milk',
    prices: [
      {size: 'S', price: '1.38', currency: '$'},
  ...
  },
  {
    ...
    description: `Cortado translates to cut, meaning that the coffee is cut with milk. A cortado coffee is made of equal parts espresso and steamed milk. It is served with a double shot espresso.`,
    roasted: 'Medium Roasted',
    imagelink_square: require('../assets/coffee_assets/cortado/square/cortado_pic_2_square.png'),
    imagelink_portrait: require('../assets/coffee_assets/cortado/portrait/cortado_pic_2_portrait.png'),
    ingredients: 'Milk',
    special_ingredient: 'With Steamed Milk',
    prices: [
      {size: 'S', price: '1.38', currency: '$'},
  ...
  },
  {
    ...
    roasted: 'Medium Roasted',
    imagelink_square: require('../assets/coffee_assets/iced_coffee/square/iced_coffee_pic_1_square.png'),
    imagelink_portrait: require('../assets/coffee_assets/iced_coffee/portrait/iced_coffee_pic_1_portrait.png'),
    ingredients: 'Milk',
    special_ingredient: 'With Steamed Milk',
    prices: [
      {size: 'S', price: '1.38', currency: '$'},
  ...
  },
  {
    ...
    description: `Quite simply, an iced coffee is a cold version of your favourite coffee, but it's not simply a coffee that has been left to cool. Like a regular coffee, it's usually a combination of hot espresso and milk. However, ice is added too.`,
    roasted: 'Medium Roasted',
    imagelink_square: require('../assets/coffee_assets/iced_coffee/square/iced_coffee_pic_2_square.png'),
    imagelink_portrait: require('../assets/coffee_assets/iced_coffee/portrait/iced_coffee_pic_2_portrait.png'),
    ingredients: 'Milk',
    special_ingredient: 'With Steamed Milk',
    prices: [
      {size: 'S', price: '1.38', currency: '$'},
  ...
  },
  {
    id: 'C23',
    name: 'Ristretto',
    description: `Ristretto refers to a short (restricted) shot of espresso, meaning the barista pulls only the first portion of a full-length espresso shot.`,
    roasted: 'Medium Roasted',
    imagelink_square: require('../assets/coffee_assets/ristretto/square/ristretto_pic_1_square.png'),
    imagelink_portrait: require('../assets/coffee_assets/ristretto/portrait/ristretto_pic_1_portrait.png'),
    ingredients: 'Milk',
    special_ingredient: 'With Steamed Milk',
    prices: [
      {size: 'S', price: '1.38', currency: '$'},
  ...
  }, 
  {
    ...
    description: `Ristretto refers to a short (restricted) shot of espresso, meaning the barista pulls only the first portion of a full-length espresso shot.`,
    roasted: 'Medium Roasted',
    imagelink_square: require('../assets/coffee_assets/ristretto/square/ristretto_pic_2_square.png'),
    imagelink_portrait: require('../assets/coffee_assets/ristretto/portrait/ristretto_pic_2_portrait.png'),
    ingredients: 'Milk',
    special_ingredient: 'With Steamed Milk',
    prices: [
      {size: 'S', price: '1.38', currency: '$'},
  ...
  },
  {
    id: 'C25',
    name: 'Lungo',
    description: `Lungo ( lit. 'long') is a coffee beverage made by using an espresso machine to make an Italian-style coffee—short black (a single espresso shot) with more water (generally twice as much), resulting in a larger coffee, a lungo.`,
    roasted: 'Medium Roasted',
    imagelink_square: require('../assets/coffee_assets/lungo/square/lungo_pic_1_square.png'),
    imagelink_portrait: require('../assets/coffee_assets/lungo/portrait/lungo_pic_1_portrait.png'),
    ingredients: 'Milk',
    special_ingredient: 'With Steamed Milk',
    prices: [
      {size: 'S', price: '1.38', currency: '$'},
  ...
  },
  {
    ...
    description: `Lungo ( lit. 'long') is a coffee beverage made by using an espresso machine to make an Italian-style coffee—short black (a single espresso shot) with more water (generally twice as much), resulting in a larger coffee, a lungo.`,
    roasted: 'Medium Roasted',
    imagelink_square: require('../assets/coffee_assets/lungo/square/lungo_pic_2_square.png'),
    imagelink_portrait: require('../assets/coffee_assets/lungo/portrait/lungo_pic_2_portrait.png'),
    ingredients: 'Milk',
    special_ingredient: 'With Steamed Milk',
    prices: [
      {size: 'S', price: '1.38', currency: '$'},
